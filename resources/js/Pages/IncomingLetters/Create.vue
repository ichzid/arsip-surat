                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input v-model="form.origin" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            </div>

                            <!-- Tanggal Surat -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Tanggal Surat</label>
                                <input v-model="form.mail_date" type="date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                <input v-model="form.received_date" type="date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <p class="text-xs text-gray-500 mt-1">*Kosongkan untuk menggunakan tanggal hari ini</p>
                            </div>

                            <!-- File Upload -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700">File Surat (PDF Max 5MB)</label>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Hanya file PDF yang diperbolehkan. Maksimal ukuran file 5MB.</p>
                        ...
                        <div class="mt-6 flex justify-end">
                            <Link :href="route('incoming-letters.index')" class="mr-3 px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400">Batal</Link>
